...
const Explore = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen bg-gradient-to-r from-gray-700 via-gray-900 to-black py-4">
      <p className="font-bold text-5xl text-[#8e64ff] mt-10">Explore Clothes</p>
      ...
      <div className="flex flex-row w-[100%] space-x-8 items-center justify-center px-6 gap-8 mt-10">
        <div className=" flex flex-col p-2 items-center justify-center rounded-lg shadow bg-gradient-to-r from-gray-400 via-gray-600 to-blue-800 w-2/6 h-88 ">
          <img src="tshirt.png" className="w-[90%]" />
          <p className="font-bold text-2xl text-black mb-10">White Shirt</p>
        </div>
        <div className=" flex flex-col p-2 items-center justify-center rounded-lg shadow bg-gradient-to-r from-gray-400 via-gray-600 to-blue-800 w-2/6 h-88 ">
          <img src="tshirt.png" className="w-[90%]" />
          <p className="font-bold text-2xl text-black mb-10">White Shirt</p>
      ...
      <div className="mt-8 flex flex-col p-2 items-center justify-center rounded-lg shadow bg-gradient-to-r from-gray-400 via-gray-600 to-blue-800 w-2/6 h-88 ">
        <img src="tshirt.png" className="w-[90%]" />
        <p className="font-bold text-2xl text-black mb-10">White Shirt</p>
      </div>
    </div>
