...
const[ password, setPassword ] = useState('');
  ...
  return (
    <div className='bg-gray-800 flex flex-col items-center justify-center min-h-screen w-full background-image'>
      ...
      <div className='bg-[#98CABD] flex flex-col items-center justify-center w-2/5 gap-4 rounded-lg text-black bg-opacity-80 p-4'>
        ...
        />
          ...
          <p>Or</p>
          <p>New on Say it ⁉ </p>
          <button className='bg-[#F84C60] text-black font-semibold p-2 w-[30%] rounded-full hover:bg-red-800 hover:text-white mb-2'>Sign Up</button>
